...
#   qa = RetrievalQA.from_chain_type(llm=OpenAI(), chain_type="stuff", retriever=docsearch.as_retriever(search_type="mmr", search_kwargs={'k': 5, 'fetch_k': 50}), chain_type_kwargs=chain_type_kwargs)
...
custom_template = """
You are an assistant. Given the chat history and a new question, provide a detailed and comprehensive answer. If you don't know the answer, kindly state that you're unsure. 
...
query = "what if the Trays imperfect?"
